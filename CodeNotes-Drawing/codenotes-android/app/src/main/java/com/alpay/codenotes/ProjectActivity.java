...
import com.alpay.codenotes.base.NFCActivity;
...
public class ProjectActivity extends AppCompatActivity {
    ...
    public void saveProgram(){
        ...
        TextRecognition textRecognition = new TextRecognition(program);
        program.setProgramName(programNameET.getText().toString());
        program.setProgramImages(imagePickerAdapter.getImageList());
        textRecognition.saveTextRecogResult(imagePickerAdapter.getImageBitmapList(this));
    ...
    protected void onResume() {
        super.onResume();
        NFCActivity.setupForegroundDispatch(this);
    }

    @Override
    protected void onPause() {
        NFCActivity.stopForegroundDispatch(this);
        super.onPause();
    }
