...
import com.alpay.codenotes.models.Conditional;
import com.alpay.codenotes.models.Output;
...
public class AddStatementActivity extends BaseActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PICK_IMAGE) {
            ...
            try {
                ...
                bitmap = Utils.decodeSampledBitmapFromStream(inputStream, 300, 300);
    ...
    protected void saveNewOutputStatement() {
        ...
        if (!outputText.equals("") && bitmap != null) {
            ...
            checkIfOutputExistsAndSave(outputText, Utils.bitmapToBase64(bitmap));
        } else {
